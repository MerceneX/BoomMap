    ...
    if(result)
        ...
        "podatki":
            [{
                ...
                "nesrece": await QueryMan.customQuery("nesrece", ["dan_v_tednu","PRPO_poskodbe"],["6w","B"])+ await QueryMan.customQuery("nesrece", ["dan_v_tednu","PRPO_poskodbe"],["6w","U"])
            },
            {
                "intenzivnost": "HUDA TELESNA POŠKODBA",
                "nesrece": await QueryMan.customQuery("nesrece", ["dan_v_tednu","PRPO_poskodbe"],["6w","H"])
            },
            {
                "intenzivnost": "LAŽJA TELESNA POŠKODBA",
                "nesrece": await QueryMan.customQuery("nesrece", ["dan_v_tednu","PRPO_poskodbe"],["6w","L"])
            },
            {
                "intenzivnost": "SMRT",
                "nesrece": await QueryMan.customQuery("nesrece", ["dan_v_tednu","PRPO_poskodbe"],["6w","S"])
            }]
        };
        res.json(result);
    }
...
router.get("/36", async (req, res) => {
    ...
    if(result)
        ...
        "podatki":
            [{
                "intenzivnost": "BREZ POŠKODBE",
                "nesrece": await QueryMan.customQuery("nesrece", ["je_praznik","PRPO_poskodbe"],[true,"B"])+ await QueryMan.customQuery("nesrece", ["je_praznik","PRPO_poskodbe"],[true,"U"])
            },
                {
                    "intenzivnost": "HUDA TELESNA POŠKODBA",
                    "nesrece": await QueryMan.customQuery("nesrece", ["je_praznik","PRPO_poskodbe"],[true,"H"])
                },
                {
                    "intenzivnost": "LAŽJA TELESNA POŠKODBA",
                    "nesrece": await QueryMan.customQuery("nesrece", ["je_praznik","PRPO_poskodbe"],[true,"L"])
                },
                {
                    "intenzivnost": "SMRT",
                    "nesrece": await QueryMan.customQuery("nesrece", ["je_praznik","PRPO_poskodbe"],[true,"S"])
                }]
        };
        res.json(result);
    }
        ...
        result = {
            ...
            "podatki":
                    [{
                        ...
                        "nesrece": await QueryMan.customQuery("nesrece", ["PRPV_Tip_Nesrece", "PRPO_poskodbe"], ["BT", "S"])
                    },
                    {
                        "intenzivnost": "ČELNO TRČENJE",
                        "nesrece": await QueryMan.customQuery("nesrece", ["PRPV_Tip_Nesrece", "PRPO_poskodbe"], ["�T", "S"])
                    },
                    {
                        "intenzivnost": "NALETNO TRČENJE",
                        "nesrece": await QueryMan.customQuery("nesrece", ["PRPV_Tip_Nesrece", "PRPO_poskodbe"], ["NT", "S"])
                    },
                    {
                        "intenzivnost": "OPLAŽENJE",
                        "nesrece": await QueryMan.customQuery("nesrece", ["PRPV_Tip_Nesrece", "PRPO_poskodbe"], ["OP", "S"])
                    },
                    {
                        "intenzivnost": "OSTALO",
                        "nesrece": await QueryMan.customQuery("nesrece", ["PRPV_Tip_Nesrece", "PRPO_poskodbe"], ["OS", "S"])
                    },
                    {
                        "intenzivnost": "POVOŽENJE PEŠCA",
                        "nesrece": await QueryMan.customQuery("nesrece", ["PRPV_Tip_Nesrece", "PRPO_poskodbe"], ["PP", "S"])
                    },
                    {
                        "intenzivnost": "PREVRNITEV VOZILA",
                        "nesrece": await QueryMan.customQuery("nesrece", ["PRPV_Tip_Nesrece", "PRPO_poskodbe"], ["PR", "S"])
                    },
                    {
                        "intenzivnost": "POVOŽENJE ŽIVALI",
                        "nesrece": await QueryMan.customQuery("nesrece", ["PRPV_Tip_Nesrece", "PRPO_poskodbe"], ["PZ", "S"])
                    },
                    {
                        "intenzivnost": "TRČENJE V OBJEKT",
                        "nesrece": await QueryMan.customQuery("nesrece", ["PRPV_Tip_Nesrece", "PRPO_poskodbe"], ["TO", "S"])
                    },
                    {
                        "intenzivnost": "TRČENJE V STOJEČE / PARKIRANO VOZILO",
                        "nesrece": await QueryMan.customQuery("nesrece", ["PRPV_Tip_Nesrece", "PRPO_poskodbe"], ["TV", "S"])
                    }]
        };
        res.json(result);
    }
