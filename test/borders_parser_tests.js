...
describe('BordersParser ', () => {
	describe('Testing BordersParser parser when parsing data string provided by BordersGuy', () => {
				...
				items: [
					{
						...
						location: "Ilirska",
						category: "Zastoj",
						description: "G1-6, mejni prehod Jelšane, Rupa, čakalne dobe: osebna vozila 45 min pri vstopu.",
					...
					},
					{
						...
						location: "Obrežje",
						category: "Zastoj",
						description: "A2, mejni prehod Obrežje, Bregana, čakalne dobe: osebna vozila 1 h pri vstopu.",
					...
					},
					{
						...
						location: "Gruškovje",
						category: "Zastoj",
						description: "A4, mejni prehod Gruškovje, Macelj, čakalne dobe: osebna vozila 30 min pri vstopu.",
		...
		it('should throw error on recieving an empty string.', async () => {
			...
			await expect(new BordersParser().parseFeed(data)).to.be.rejectedWith(expectedResult);
			await expect(new BordersParser().parseFeed(data)).to.be.rejectedWith(TypeError);
		})
	});
});