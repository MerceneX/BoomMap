			...
			<Layout>
				...
				<Container className="aboutContainer">
					...
					<Row>
						<Col sm={8}>
							<p>
								V Republiki Sloveniji smo od osamosvojitve zgradili mnoge
								državne in lokalne ceste, ki (zaradi širitve na eni in manj
								vzdrževanja na drugi strani) veljajo za dokaj nevarne. Najhujših
								prometnih nesreč s smrtnim izidom je zadnja leta res manj, a to
								žal ne velja za nesreče v splošnem, pa naj imajo zgolj
								materialne ali tudi blage oz. hujše telesne poškodbe. Eden izmed
								mehanizmov za povečanje varnosti je opozarjanje udeležencev na
								t. i. nevarne cestne odseke. Menimo, da je v smeri prepoznavanja
								in ozaveščanja udeležencev prometa mogoče narediti še več. Sami
								smo s to mislijo, skovali vizijo o spletni rešitvi, ki bi
								zajemala naprednejšo in učinkovitejšo klasifikacijo cestnih
								odsekov, ter oceno stopnje njihove nevarnosti.{" "}
							</p>
						</Col>
						<Col sm={4}>
					...
					<Row>
						<Col>
							...
							<p>
								...
								sveže tehnologije. Razmišljali smo v smislu odzivnosti, izgleda
								in agilnega programiranja. Na koncu smo se odločili za:
								<ul>
									<li>React za uporabniški vmesnik</li>
									<li>
										Python za strojno učenje, s knjižnico Efficient Apriori
									</li>
				...
				<Container className="aboutContainer">
					...
					<Row>
						<Col>
							<p>
								Smo ekipa štirih študentov univerzitetnega programa Informatike
								in Tehnologij Komuniciranja na Fakulteti za Elektrotehniko,
								Računalništvo in Informatiko Univerze v Mariboru. Rešitev, ki
								vam jo predstavljamo, smo začeli v sklopu zaključnega
								projektnega dela ob koncu 2. letnika. Po koncu petih tednov
								obveznega dela smo verjeli, da imamo dobro idejo, možnosti
