					...
					<Row className="contentContainer">
						...
						<Col sm={4} className="fpCol">
							...
							<p>
								...
								naprej. Prikaz števila prometnih nesreč glede na različne
								filtre.
							</p>
							<a href="/statistika">
								Preberi več <FaAngleRight />
						...
						<Col sm={4} className="fpCol">
							...
							<p>
								Prometna poročila, stanja na mejnihi prehodih in aktualni
								dogodki na cestah.{" "}
							</p>
						...
						<Col sm={4} className="fpCol">
							...
							<p>
								Napovedi prometa za prihajajoče dni, posebnosti na cesti,
								dogodki in ostale pomembne informacije.{" "}
							</p>
							<a href="/napovedi">
								Preberi več <FaAngleRight />
							</a>
